...
opts.Add(PathVariable('target_path', 'The path where the lib is installed.', 'addons/gdfastnoise/bin/'))
opts.Add(PathVariable('target_name', 'The library name.', 'libfastnoise', PathVariable.PathAccept))
opts.Add(EnumVariable('bits', "Compilation architecture", "64", ["32", "64"]))
